...
final class Version20230329102015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE organization (id INT AUTO_INCREMENT NOT NULL, organization_type_id INT DEFAULT NULL, state TINYINT(1) NOT NULL, organizer_name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, logo VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, postcode INT NOT NULL, city VARCHAR(255) NOT NULL, website_url VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, number_phone VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, INDEX IDX_C1EE637C89E04D0 (organization_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, competition_id INT DEFAULT NULL, user_id INT DEFAULT NULL, state TINYINT(1) NOT NULL, picture_name VARCHAR(255) NOT NULL, submission_date DATETIME NOT NULL, file VARCHAR(255) NOT NULL, number_of_votes INT NOT NULL, price_won TINYINT(1) NOT NULL, price_rank INT NOT NULL, INDEX IDX_16DB4F897B39D312 (competition_id), INDEX IDX_16DB4F89A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE refresh_tokens (id INT AUTO_INCREMENT NOT NULL, refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid DATETIME NOT NULL, UNIQUE INDEX UNIQ_9BACE7E1C74F2195 (refresh_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rent (announcement_id INT AUTO_INCREMENT NOT NULL, organization_id INT DEFAULT NULL, advertising_id INT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, url_click VARCHAR(255) NOT NULL, alt_tag VARCHAR(255) NOT NULL, price_sold INT NOT NULL, number_of_clicks INT NOT NULL, INDEX IDX_2784DCC32C8A3DE (organization_id), INDEX IDX_2784DCC9F084B42 (advertising_id), PRIMARY KEY(announcement_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sponsors (id INT AUTO_INCREMENT NOT NULL, organization_id INT DEFAULT NULL, competition_id INT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, sponsor_rank INT NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_9A31550F32C8A3DE (organization_id), INDEX IDX_9A31550F7B39D312 (competition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
