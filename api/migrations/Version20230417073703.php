...
final class Version20230417073703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competition ADD competition_visual_id INT DEFAULT NULL, DROP competition_visual, DROP publication_start_date');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B50A2CB1CB3905A3 ON competition (competition_visual_id)');
        $this->addSql('ALTER TABLE organization ADD logo_id INT DEFAULT NULL, ADD number_siret VARCHAR(255) NOT NULL, CHANGE postcode postcode VARCHAR(255) NOT NULL, CHANGE logo intra_community_vat VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE picture ADD file_id INT DEFAULT NULL, DROP file');
        $this->addSql('ALTER TABLE picture ADD CONSTRAINT FK_16DB4F8993CB796C FOREIGN KEY (file_id) REFERENCES file (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_16DB4F8993CB796C ON picture (file_id)');
        ...
        $this->addSql('CREATE INDEX IDX_8D93D649F98CFEEE ON user (personal_statut_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competition ADD competition_visual VARCHAR(255) NOT NULL, ADD publication_start_date DATETIME NOT NULL, DROP competition_visual_id');
        $this->addSql('DROP INDEX UNIQ_C1EE637CF98F144A ON organization');
        $this->addSql('ALTER TABLE organization ADD logo VARCHAR(255) NOT NULL, DROP logo_id, DROP intra_community_vat, DROP number_siret, CHANGE postcode postcode INT NOT NULL');
        $this->addSql('DROP INDEX UNIQ_16DB4F8993CB796C ON picture');
        $this->addSql('ALTER TABLE picture ADD file VARCHAR(255) NOT NULL, DROP file_id');
