    ...
    return (
        <>
            <div style={{height: "100%", position: "relative" }}>
                ...
                >
                    <div className={`${style.swiperButton} ${style.swiperButtonPrev}`} ref={navigationPrevRef}>
                        <Icon icon="cheveron-left" size={30} />
                    </div>
                    <div className={`${style.swiperButton} ${style.swiperButtonNext}`} ref={navigationNextRef}>
