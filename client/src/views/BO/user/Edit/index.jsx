            ...
            >
                <div>
                    <Input
                        ...
                        label="Prénom"
                        extra={{ required: true }}
                        onChange={d => updateEntityStateState('firstname', d)}
                    ...
                    <Input
                        ...
                        label="Nom"
                        extra={{ required: true }}
                        onChange={d => updateEntityStateState('lastname', d)}
                    ...
                    <Input
                        ...
                        extra={{ required: true }}
                        onChange={d => updateEntityStateState('dateOfBirth', d)}
                    ...
                    <Input
                        ...
                        label="Adresse mail"
                        extra={{ required: true }}
                        onChange={d => updateEntityStateState('email', d)}
                    ...
                    <Input
                        ...
                        onChange={d => updateEntityStateState('state', d)}
                    />
                    ...
                    <Input
                        ...
                        extra={{ required: true }}
                        onChange={d => updateEntityStateState('address', d)}
                    />
                    ...
                    <div style={{ display: 'flex', gap: '30px' }}>
                        ...
                        <Input
                            ...
                            onChange={d =>
                                updateEntityStateState('postcode', d)
                            }
                        />
                    </div>
                    <Input
                    ...
                    <Input
                        ...
                        name="password"
                        label="Mot de passe"
                        onChange={d => updateEntityStateState('password', d)}
                    ...
                    <Input
                        ...
                        onChange={d =>
                            updateEntityStateState('passwordConfirm', d)
                        }
