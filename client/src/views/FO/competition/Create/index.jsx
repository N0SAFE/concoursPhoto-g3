...
export default function CreateCompetitions() {
    ...
    return (
        <Loader active={isLoading}>
            ...
            {me?.roles?.includes("ROLE_ORGANIZER") ? <BOCreate
            ...
            >
                <div className={style.formContainer}>
                    ...
                    <div style={{ paddingTop: "2%" }} className={style.formWrapper}>
                        <div className={style.formRow}>
                            <Input
                                type="number"
                                extra={{ step: 0.01 }}
                    ...
                    <div style={{ display: 'flex', gap: '30px', paddingBottom: "2%" }}>
                        <Input
                            type="select"
                    ...
                    Veuillez <Link to="/createorganization">créer une organisation</Link> avant de créer une compétition
            </div>}
        </Loader>
    );
}
